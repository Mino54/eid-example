package be.fedict.eid.example.entity;
...
public class AdministratorEntity implements Serializable {
	...
	public static final String COUNT_ALL_ACTIVE = "eid.example.count.all.active";

	public static final String ALL = "eid.example.admin.all";
